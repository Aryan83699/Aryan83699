...
<p align="left">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=24&pause=500&width=700&lines=Python+Developer;Kaggle+Notebook+Expert;Aspiring+Data+Analyst" />
</p>

Transforming raw data into meaningful insights through analytics, visualization, and data-driven solutions.
...
📈 Experienced in Exploratory Data Analysis (EDA), Dashboard Development, and Statistical Analysis
...
### 📊 DataPulse Auto EDA Platform



**Impact:**

* Enabled fast end-to-end data analysis for non-technical users
* Reduced manual EDA effort through automated profiling and reporting
* Improved decision-making with AI-generated insights
* Integrated chatbot for dataset and domain understanding
* Simplified exploratory analysis through an interactive web interface
...
* Identified trends across genres, countries, and content types
...
📊 Kaggle: https://www.kaggle.com/datawitharyan
